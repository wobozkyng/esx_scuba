Locales['en'] = {
    ['no_tank'] = 'Currently do not have an oxygen tank',
    ['tank_loaded'] = 'Tank loaded %s %s',
    ['tank_capacity'] = 'Current tank capacity is %s %s',
    ['tank_remaining'] = 'Tank capacity remaining is %s %s',
    ...
    ['not_equipped'] = 'Not equipping oxygen tank at the moment'
}
